import { ArrowLeftStartOnRectangleIcon, Bars4Icon, CalendarDateRangeIcon, ChartPieIcon, RectangleGroupIcon, UserGroupIcon, XMarkIcon } from "@heroicons/react/24/outline";
...
const HamburgerMenu = () => {
    ...
    return (
        <div className="bg-neutral-900 shadow-neutral-600 z-10 fixed top-0 
            ...
            <img src="/logo.png" alt="logo" className="h-20 w-20" onClick={() => (window.location.href = "/")} />
            ...
            {isOpen &&
                <div className="text-white flex basis-full flex-col items-start px-4">
