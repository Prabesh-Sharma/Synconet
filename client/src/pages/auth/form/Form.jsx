  ...
  return (
    <>
      <div className="w-full h-screen gap-x-60 flex flex-row items-center justify-center text-white">
        <div
          className="w-11/12 md:w-1/2 lg:w-1/3 xl:w-1/4 h-3/4 border border-neutral-500/50 bg-neutral-800/20 rounded 
            flex flex-col items-center justify-center relative"
        >
          <div className="absolute top-0 left-0 w-full h-full flex items-center justify-center lg:hidden opacity-35 -z-10">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="mt-12 w-full flex justify-center">
              {type === 'register' ? (
                ...
                >
                  Sign up
                  <UserPlusIcon className="stroke-[1.75] min-w-6 w-6" />
                </button>
              ) : (
                <button
                  className="bg-slate-50 px-2 py-1 rounded-md text-blue-950 
                ...
                >
                  Login
                  <ArrowRightEndOnRectangleIcon className="stroke-[1.75] min-w-6 w-6" />
                </button>
              )}
            </div>
